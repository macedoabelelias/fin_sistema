						...
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo @$menu_pessoas ?>">
								...
								<ul class="treeview-menu">
									<li class="<?php echo @$usuarios ?>"><a href="usuarios"><i class="fa fa-clipboard"></i> Usuários</a></li>

									<li class="<?php echo @$funcionarios ?>"><a href="funcionarios"><i class="fa fa-folder-open"></i> Funcionários</a></li>
							...
							<li class="treeview <?php echo @$menu_cadastros ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo @$grupo_acessos ?>"><a href="grupo_acessos"><i class="fa fa-newspaper-o"></i> Grupos</a></li>

									<li class="<?php echo @$acessos ?>"><a href="acessos"><i class="fa fa-folder-open-o"></i> Acessos</a></li>
							...
							<li class="treeview <?php echo @$menu_financeiro ?>">
								...
								<ul class="treeview-menu">
									<li class="<?php echo @$receber ?>"><a href="receber"><i class="fa fa-dollar"></i> Receita</a></li>

									<li class="<?php echo @$pagar ?>"><a href="pagar"><i class="fa fa-cc-mastercard"></i> Despesas</a></li>
