			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;" id="aside-navbar">
				<nav class="navbar navbar-inverse" >
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span class="fa fa-heartbeat"></span> Sistema<span class="dashboard_text"><?php echo $nome_sistema ?></span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo @$menu_pessoas ?>">
								...
								<ul class="treeview-menu">
									<li class="<?php echo @$usuarios ?>"><a href="usuarios"><i class="fa fa-file-o"></i> Usuários</a></li>

									<li class="<?php echo @$funcionarios ?>"><a href="funcionarios"><i class="fa fa-list-alt"></i> Funcionários</a></li>
							...
							<li class="treeview <?php echo @$menu_cadastros ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo @$grupo_acessos ?>"><a href="grupo_acessos"><i class="fa fa-folder-o"></i> Grupos</a></li>
