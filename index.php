...
<body>
	<div class="login">		
		<div class="form">
			...
			<br>
			<p class="recuperar"><a title="Clique para recupearar a senha" href="" data-bs-toggle="modal" data-bs-target="#exampleModal" style="color:#34364d; font-size:16px">Recuperar Senha</a></p>
